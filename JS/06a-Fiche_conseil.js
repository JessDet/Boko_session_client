const articles = [
    ...
    },
    {
        ...
        timing:'10 à 15 min',
        img: '/IMG/Photos temps de cuisson'
    },
    {
        id: 12,
    ...
    },
    {
        ...
        timing:'Rincer et amener juste à ébullition dans un grand volume d’eau salée.Égoutter puis cuire 1 volume de lentilles dans un volume d’eau avec aromates, à feu doux 15 minutes.',
        img: '/IMG/Aliments/trio de lentilles.jpg'
    },
    {
        id: 15,
        denomination: "Boulgour",
        timing: 'Faire revenir le Boulgour dans du beurre. Couvrir d’eau bouillante salée. Laisser cuire 2 minutes. Couvrez 15 minutes. 2 volumes d’eau pour 1 volume de boulgour.',
        img: '/IMG/Aliments/boulgour-gros-demi-complet-min.jpg'
    },
    {
        id: 16,
        denomination: "Couscous",
        timing:'Verser 1 volume d’eau bouillante salée sur 1 volume de couscous et couvrir 5 minutes.',
        img: '/IMG/Aliments/couscous-blanc-min.jpg'
    },
    {
        id: 17,
        denomination: "Quinoa",
        timing:'Rincer le quinoa. Dans une casserole ajouter 1,5 à 2 fois son volume d’eau salée, selon si vous préférez une cuisson « al dente » ou bien cuit. Couvrez. Portez à ébullition. Baisser le feu et laisser cuire 10 minutes. Ôter du feu et laisser gonfler 5 minutes toujours à couvert.',
        img: '/IMG/Aliments/quinoa-min.jpg'
    },
    {
        id: 18,
        denomination: "Taboulé",
        timing:'Verser un volume d’eau bouillante salée et le jus d’un ou deux citrons sur un volume de préparation. Couvrir. Laisser gonfler 5 minutes. Égrainer à la fourchette.',
    ...
    },
    {
        ...
        timing:'Faire revenir la préparation avec un peu d’huile d’olive pendant 5 minutes. Couvrir d’un grand volume d’eau bouillante salée, 75cl pour 250g, et laisser cuire 15 minutes.',
...
const createArticleElement = (article) => {      //fonction qui crée un article
    ...
    divArticle.append(image, h2, paragraph,);
    return divArticle
